...
void ProjectApplication::SetupGameplay()
{
...
void ProjectApplication::UpdateGameplay(double dt)
{
...
void ProjectApplication::RenderGameplay()
{
    // RenderMousePick();
...
void ProjectApplication::RenderUIGameplay(double dt)
{
