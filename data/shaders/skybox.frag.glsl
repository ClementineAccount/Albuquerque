...
uniform float upper_limit_y_bound = 5.0f; //Figure out what unit this upper limit should be considered in to be honest
uniform float lower_limit_y_bound = 0.0f;
